...
#SBATCH --output=logs/slurm/interian_random3sat_n100_%j.out
#SBATCH --error=logs/slurm/interian_random3sat_n100_%j.err
...
echo "===== Interian REINFORCE | random_3sat/n100 ====="
echo "Start: $(date)"
TOTAL_START=$(date +%s)
