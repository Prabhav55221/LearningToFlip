...
#SBATCH --output=logs/slurm/interian_kcoloring_n200_%j.out
#SBATCH --error=logs/slurm/interian_kcoloring_n200_%j.err
...
echo "===== Interian REINFORCE | kcoloring/n200 ====="
echo "Start: $(date)"
TOTAL_START=$(date +%s)
