...
mkdir -p experiments/models/kclique/n5/mlp_full_e_norm_nw_rn
mkdir -p experiments/results/ours/run7/kclique
mkdir -p logs/slurm

echo "===== Run 7: mlp/full+entropy+norm+noise_walk+reward_norm | kclique/n5 ====="
echo "Start: $(date)"
TOTAL_START=$(date +%s)
...
python scripts/evaluate.py \
    ...
    --normalize-features \
    --noise-walk \
    --model-path experiments/models/kclique/n5/mlp_full_e_norm_nw_rn/best_mlp_full_e_norm_nw_rn.pt \
    --max-tries 10 \
