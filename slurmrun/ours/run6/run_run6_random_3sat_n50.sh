...
#SBATCH --output=logs/slurm/run6_random_3sat_n50_%j.out
#SBATCH --error=logs/slurm/run6_random_3sat_n50_%j.err
...
mkdir -p experiments/models/random_3sat/n50/mlp_full
...
python scripts/evaluate.py \
    ...
    --max-tries 10 \
    --save-csv experiments/results/ours/run6/random_3sat/n50_val.csv
END=$(date +%s)
