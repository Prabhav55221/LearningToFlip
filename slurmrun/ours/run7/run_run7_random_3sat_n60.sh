...
mkdir -p experiments/models/random_3sat/n60/mlp_full_e_norm_nw_rn
mkdir -p experiments/results/ours/run7/random_3sat
mkdir -p logs/slurm

echo "===== Run 7: mlp/full+entropy+norm+noise_walk+reward_norm | random_3sat/n60 ====="
echo "Start: $(date)"
TOTAL_START=$(date +%s)
...
python scripts/evaluate.py \
    ...
    --normalize-features \
    --noise-walk \
    --model-path experiments/models/random_3sat/n60/mlp_full_e_norm_nw_rn/best_mlp_full_e_norm_nw_rn.pt \
    --max-tries 10 \
